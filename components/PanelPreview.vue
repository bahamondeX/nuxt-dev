...
<template>
  <div
    h-full
    :class="
      play.status === 'ready' ? ' grid grid-rows-[min-content_1fr]' : 'flex'
    "
  >
    <div
    ...
    >
      ...
      <div v-else flex="~ gap-2 auto items-center" px2 py2>
        <div i-ph-globe-duotone />
      ...
      <VDropdown :distance="6">
        <button rounded p1 hover="bg-active" title="Playground Information">
        ...
        <template #popper>
          ...
          >
            ...
            <div flex="~ gap-2 items-center">
              ...
              />
              <!-- eslint-disable-next-line @intlify/vue-i18n/no-raw-text -->
              <code v-else> v{{ preview.clientInfo.versionVue }} </code>
            </div>
            ...
            <div flex="~ gap-2 items-center">
              ...
              />
              <!-- eslint-disable-next-line @intlify/vue-i18n/no-raw-text -->
              <code v-else> v{{ preview.clientInfo.versionNuxt }} </code>
            </div>
          </div>
        </template>
      </VDropdown>
